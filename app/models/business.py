...
class Business(db.Model):
    ...
    images= db.relationship('Image', cascade='all, delete-orphan', back_populates='business')
    reviews=db.relationship('Review', cascade='all, delete-orphan', back_populates='business')
